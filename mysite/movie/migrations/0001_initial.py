    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor_name_ru', models.CharField(max_length=32, null=True, unique=True)),
                ('actor_name_en', models.CharField(max_length=32, null=True, unique=True)),
                ('bio', models.TextField()),
                ('bio_ru', models.TextField(null=True)),
                ('bio_en', models.TextField(null=True)),
                ('age', models.PositiveSmallIntegerField(blank=True, default=0, null=True, validators=[django.core.validators.MinValueValidator(15), django.core.validators.MaxValueValidator(90)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('director_name_ru', models.CharField(max_length=32, null=True, unique=True)),
                ('director_name_en', models.CharField(max_length=32, null=True, unique=True)),
                ('bio', models.TextField()),
                ('bio_ru', models.TextField(null=True)),
                ('bio_en', models.TextField(null=True)),
                ('age', models.PositiveSmallIntegerField(blank=True, default=0, null=True, validators=[django.core.validators.MaxValueValidator(90)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre_name_ru', models.CharField(max_length=200, null=True, unique=True)),
                ('genre_name_en', models.CharField(max_length=200, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', multiselectfield.db.fields.MultiSelectField(choices=[('144', '144p'), ('360', '360p'), ('480', '480p'), ('720', '720p'), ('1080', '1080p')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.movie')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movie.rating')),
